    ...
    const [photos] = useState([
        {
            ...
            description: 'An online recipe database that allows users to login and share their own receipes and comment on others.'
        },
        {
            ...
            description: 'Users can search news specific to a google maps search of a city.'
        },
        {
            name: 'Tech Blog',
            ...
            description: 'Users can log in and post, comment on a tech message board.'
        },
        {
            ...
            description: 'User can search 5 day weather forecast for a particular city.'
        },
        {
